...
public class XWPFDocumentUtil extends XWPFDocument {
    private static Logger logger = LoggerFactory.getLogger(Object.class);

    public XWPFDocumentUtil(InputStream in) throws IOException {
        super(in);
    }

    public XWPFDocumentUtil() {
        super();
    }
     ...
     * @throws IOException
     */
    public XWPFDocumentUtil(OPCPackage pkg) throws IOException {
        super(pkg);
